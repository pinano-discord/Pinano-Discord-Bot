...
function loadCommands (client) {
  ...
  client.commands['addtime'] = (client, message) => { return addtime(client, message) }
  client.commands['bitrate'] = (client, message) => { return bitrate(client, message) }
  client.commands['deltime'] = (client, message) => { return deltime(client, message) }
  client.commands['help'] = (client, message) => { return help(client, message) }
  client.commands['lock'] = (client, message) => { return lock(client, message) }
  client.commands['recital'] = client.commands['recitals'] = (client, message) => { return recital(client, message) }
  client.commands['restart'] = client.commands['reboot'] = (client, message) => { return restart(client, message) }
  client.commands['rooms'] = (client, message) => { return rooms(client, message) }
  client.commands['stats'] = (client, message) => { return stats(client, message) }
  client.commands['unlock'] = (client, message) => { return unlock(client, message) }
}
